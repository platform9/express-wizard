...
EXPRESS_CLI_CONFIG_DIR = "{}/pf9/pf9-express/config".format(expanduser("~"))
EXPRESS_CLI_CONFIG_FILE = "{}/express.conf".format(EXPRESS_CLI_CONFIG_DIR)
...
EXPRESS_CLI_BRANCH = "dwright/test01"

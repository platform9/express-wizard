{
  "actions": [
      {
          ...
          "region-name": "https://cs-int42.platform9.horse"
      },
      {
  ...
  "region": {
    ...
    "auth_password": "",
    "url": "https://cs-int42.platform9.horse",
    "region": "k8s01",
    "region_proxy": "",
    "git_branch": "master",
